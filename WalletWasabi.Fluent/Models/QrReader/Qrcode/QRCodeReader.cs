	...
	public class QRCodeReader : IReader
	{
		...
		public Result Decode(BinaryBitmap image, IDictionary<DecodeHintType, object> hints)
		{
			...
			if (hints != null && hints.ContainsKey(DecodeHintType.PURE_BARCODE))
			{
				...
				decoderResult = _decoder.Decode(bits, hints);
				points = NO_POINTS;
			}
			else
			{
				...
				decoderResult = _decoder.Decode(detectorResult.Bits, hints);
			...
			QRCodeDecoderMetaData data = (QRCodeDecoderMetaData)decoderResult.Other;
			if (data != null)
			{
